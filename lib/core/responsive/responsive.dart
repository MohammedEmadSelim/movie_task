...
class ResponsiveService {
  static const Size _designSize = Size(428, 977);
  static const bool _splitScreenMode = false;
  static final MediaQueryData _mediaQueryData = MediaQueryData.fromView(WidgetsBinding.instance.platformDispatcher.views.first);

  static Size _switchableDesignSize() {
    return _mediaQueryData.orientation == Orientation.portrait ? _designSize : const Size(977, 428);
  }
  ...
  static double scaleHeight() => (_splitScreenMode ? max(availableScreenHeight(), 977) : availableScreenHeight()) / _switchableDesignSize().height;
