                        ...
                        children: [
                          ...
                          Row(
                            ...
                            CustomSvgImage(image: AppIcons.star,height: 16.h,),
                              SizedBox(width: 4.w),
                              CustomText(
                                text: '9.0', // Optional: add rating to model if needed
                                fontSizes: 13.sp,
                          ...
                          Row(
                            children: [
                              CustomSvgImage(image: AppIcons.ticket, height: 14.h,color: kWhite,),
                              SizedBox(width: 5.w),
                              CustomText(text: 'Action', fontSizes: 12.sp, textColor: kWhite),
                            ],
                          ),
                          SizedBox(height: 4.h),
                          ...
                          Row(
                            children: [
                              CustomSvgImage(image: AppIcons.calendar, height: 14.h,color: kWhite,),
                              SizedBox(width: 5.w),
                              CustomText(text: movie?.releaseDate ?? '', fontSizes: 12.sp, textColor: kWhite),
                            ],
                          ),
                          SizedBox(height: 4.h),
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 5.w),
                              CustomText(text: '139 minutes', fontSizes: 12.sp, textColor: kWhite),
                            ],
                          ),
                        ],
                      ),
